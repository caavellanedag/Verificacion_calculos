...
DATA REVISA;
SET PRUEBA.PREDIO_VISTA_USOP_MZ_ZHF;
IF MARCA_DESECHO = 1;
RUN;
...
WHEN ( NUM_USOS = 2 & NUMERO_UNIDADES = 2 & CODIGO_USO IN ('020') & (USO_001 > 0 | USO_002 > 0 ) & CLASE_PREDIO = 'N'  & MARCA_DESECHO = .) THEN 'T01' /*Residencial*/
...
WHEN ( NUM_USOS = 3 & NUMERO_UNIDADES = 3 & CODIGO_USO IN ('020') & (USO_001 > 0 & USO_022 > 0 ) & CLASE_PREDIO = 'N'  & MARCA_DESECHO = .) THEN 'T01' /*Residencial*/
...
CASE WHEN MODELO_0 IN ("T01-1", "T01-2", "T01-3", "T01-4", "T01-5", "T01-6", "T01-7", "T01-8", "T03", "T04", "T06", "T19") THEN .
...
(0.00000003090550143812070*VALOR_REFERENCIA_2020) +
...
(-0.0000000364016291742887*VALOR_REFERENCIA_2020*SUBA) +
...
(0.00000003331986410913660*VALOR_REFERENCIA_2020) +
...
(0.00000003171587684428200*VALOR_REFERENCIA_2020*USAQUEN) +
(-0.0006070396779022790000*AREA_CONSTRUIDA*SUBA) +
(-0.0042674627376339100000*AREA_CONSTRUIDA*B_UNIDOS) +
(-0.0000000644126500475659*VALOR_REFERENCIA_2020*SUBA) );	
...
(0.00000000951335789208144*VALOR_REFERENCIA_2020) +
...
(0.00000010669540991265300*VALOR_REFERENCIA_2020) +
...
(0.00000008812702143112030*VALOR_REFERENCIA_2020*SUBA) +
...
(0.00000018701964244783600*VALOR_REFERENCIA_2020) +
...
(0.00000024229812159761400*VALOR_REFERENCIA_2020*P_ARANDA) +
...
(0.00000020475489635946900*VALOR_REFERENCIA_2020) +
...
(0.00000009676003518494820*VALOR_REFERENCIA_2020*RAFAEL_U_U) +
...
(0.00000012977229922145100*VALOR_REFERENCIA_2020) +
...
(-0.0000001598407421162750*VALOR_REFERENCIA_2020*SUBA) +
