...
WHEN (CODIGO_USO IN ('012') & AREA_CONSTRUIDA <= 350 & MAX_NUM_PISO <= 4) THEN 'T01' /*Residencial*/
...
PROC SQL;
CREATE TABLE REVISA AS SELECT 
CHIP,
CODIGO_BARRIO, CODIGO_MANZANA, CODIGO_PREDIO,
CODIGO_CONSTRUCCION, CODIGO_RESTO, CHIP, AVALUO_ESP,
UNIDAD_LIQUIDACION,
VALOR_CONSTRUCCION_COM_&VIGENCIA._UM ,
AREA_TERRENO, AREA_USO,
MODELO_0, MODELO_USO, 
CODIGO_ESTRATO,
VALOR_AVALUO_COM_&VIGENCIA.,
VALOR_UNITARIO_&VIGENCIA., AREA_CONSTRUIDA, VALOR_M2_TERRENO_COR_&VIGENCIA_2. , 
 VALOR_UNITARIO_AVESP_&VIGENCIA., PRODUCTO_&VIGENCIA.,
 VALOR_INTEGRAL_&VIGENCIA., 
 VALOR_UNITARIO_AVESP_&VIGENCIA.,
 VAR_AVALUO_COM_2021_2022
FROM COMUN.PREDIO_Y_UM_FINAL_211213
WHERE MODELO_0 = "T22" AND NUM_USOS = 2;
QUIT;
